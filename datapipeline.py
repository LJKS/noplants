...
class Datapipeline:
    ...
    def get_generator(self):
        image_generator = self.image_datagen.flow_from_directory(self.data_dir, class_mode=None, seed=self.seed, batch_size=24)
        target_generator = self.target_datagen.flow_from_directory(self.target_dir, class_mode=None, seed=self.seed, batch_size=24)
